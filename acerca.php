  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="home.php">Inicio</a></li>
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>¿Quienes somos?</h2>
                <p>Somos una empresa dedicada a la venta de productos tipicos extranjeros y locales, desde prendas y comida representativa de las diferentes culturas de paises. 
                  Seguiremos trabajando para ofrecer el mejor servicio y ampliar la cantidad de productos de otros paises.
                </p>
